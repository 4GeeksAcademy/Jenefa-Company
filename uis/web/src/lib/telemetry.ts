/**
 * Centralized TelemetryService (Phase 2) for HealthCore web.
 *
...
import { EventType, isKnownEventType, validateEventProperties } from "./telemetrySchemas";
...
function resolveTelemetryEndpoint(): string {
  return process.env.NEXT_PUBLIC_TELEMETRY_ENDPOINT || `${API_BASE}/telemetry/events`;
}
