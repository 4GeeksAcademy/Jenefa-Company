...
Cada subcarpeta dentro de `uis/` debe corresponder a **una interfaz de usuario concreta** (por ejemplo `website`, `web`) e incluir su propia documentación técnica y funcional.
