"""Shared constants for the HealthCore supplier directory."""
...
CURRENCY_BY_COUNTRY = {"USA": "USD", "UK": "GBP"}

VALID_COMPLIANCE = ["BAA", "DPA", "both"]

# Categories where Claire expects a compliance agreement on file (advisory only).
COMPLIANCE_RECOMMENDED_CATEGORIES = {
    "clinical_software",
    "it_infrastructure",
    "patient_communication",
    "billing_and_coding_software",
